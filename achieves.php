...
$resultresult = mysql_query("SELECT * FROM result where memberNo ='$MemberNo' ORDER BY ResultNo DESC");
?>
    ...
    <body>
                    ...
                    <div class="modal fade" id="cusachi" tabindex="-1" role="dialog" aria-labelledby="cusachiLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="addclassform" action="classify.php" method="post">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="classify.php" method="post">
                                    ...
                                    <div class="modal-footer">                                                         
                                        <button type="button" class="btn btn-primary" onclick="editClass()">確定</button>           
                                        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>                      
                                    </div>
                                </form>
                            </div>
                            ...
                            <div id="test-list" class="row"> 
                                <ul class="list">
                                    ...
                                    while ($resultrow = mysql_fetch_row($resultresult)) {
                                        ...
                                        if ($resultrow[8] !== "") {
                                            $boximage = 'http://img.youtube.com/vi/' . substr("$resultrow[8]", 17) . '/0.jpg';
                                        } elseif (in_array($extension, $Compressed)) {
                                        ...
                                        echo '<li>';
                                        echo '<div class="box achieves">';
                                        echo '<span class="captionAchi1">';
                                        echo '<img src="' . "$boximage" . '" alt="..." class="imgwh"><br>';
                                        ...
                                        echo '<blockquote>';
                                        echo '<h4 class="name ellipsis title">' . "$resultrow[1]" . '</h4> ';
        ...
        <script>
                                        ...
                                        function editClass() {
                                            ...
                                            var bol=true;
                                            $('input:radio[name=editclass]').each(function(){
                                                    if($(this).parent().text()==classname){
                                                        bol=false;
                                                    }
                                                }
                                            );
                                            ...
                                            sweetAlert("Oops...", "分類名稱不能重複", "error");
                                            }
                                        ...
                                        $("#form1").submit(function() {
                                            if ($("input:radio[name=classify]:checked").val()==null) {
                                                sweetAlert("Oops...", "請選擇一個分類", "error");
                                                return false;
                                            }
                                            return true;
                                        });
                                         $("#addclassform").submit(function() {
                                            if ($("[name=InputClassify]").val()=="") {
                                                sweetAlert("Oops...", "請輸入分類名稱", "error");
                                                return false;
                                            }else if($("[name=InputClassify]").val()==$("#class1").text()||$("[name=InputClassify]").val()==$("#class2").text()||$("[name=InputClassify]").val()==$("#class3").text()||$("[name=InputClassify]").val()==$("#class4").text()||$("[name=InputClassify]").val()==$("#class5").text()||$("[name=InputClassify]").val()==$("#class6").text()){
                                                sweetAlert("Oops...", "分類名稱不能重複", "error");
                                                return false;
                                            }
                                            return true;
