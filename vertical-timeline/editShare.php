...
<html lang="en" class="no-js">
    ...
    <body>
		...
		<div class="col-md-4 col-sm-8 col-xs-12  col-lg-4">
            <div id="header-left">
                <input type="text" onmouseover="this.focus()" id="title" value="<?php echo $outputrow[1]?>" class="h1 text-center">
            </div>
		</div>
        ...
        <div style="text-align:center">
            <button type="submit" class="btn btn-info btn-summit" onclick="editsubmit(<?php echo filter_input(INPUT_GET, "No")?>)">送出 
        </div>
