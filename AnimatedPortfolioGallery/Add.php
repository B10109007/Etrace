...
<html lang="en">
    ...
    <body>
        <h1 class="title" id="title"><?php echo filter_input(INPUT_GET, "title"); ?></h1>
        ...
        <button type="submit" class="btn btn-info btn-summit" onclick="submit()" style="bottom:0px;right:30px;position:absolute;">送出</button>
        ...
        <div class="modal fade" style="z-index:9999;" id="addResultModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog pull-right modal-sm  slideInRight animated" id="exampleModaldia">
                <div class="modal-content"  id="addResultContent">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="saveResult($('input:radio[name=result]:checked').val(),$('#thumbcontainer').children().length)">儲存</button>
