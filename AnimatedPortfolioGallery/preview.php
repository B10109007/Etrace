...
<html lang="en">
    ...
    <body>
        ...
        $dbgo = null;
        ?>   
        <a href="../share2.php"><button type="button" class="btn btn-info btn-summit" style="bottom:0px;right:30px;position:absolute;">返回</button></a>
                    ...
                    foreach ($pg_preview as $value) {
                        if ($count === 0) {
                            if ($value['url'] !== "" && !strpos($value['url'], "img.youtube.com")) {
                                ...
                                echo '<a href="images/default.jpg" data-lightbox="image-1" data-title="' . $value['title'] . '"><img class="pg_thumb" style="display:block;z-index:9999;" src="images/default.jpg" alt="images/default.jpg"/></a>';
                            }
                        } else {
                            if ($value['url'] !== "" && !strpos($value['url'], "img.youtube.com")) {
