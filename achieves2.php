                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="sandbox-container">
                                                <div class="input-daterange input-group" id="datepicker">
                                                    <input type="text" class="input-sm form-control" id="InputStartTime" name="StartTime" value="<?php echo date('m/d/Y'); ?>">
                                                    <span class="input-group-addon">to</span>
                                                    <input type="text" class="input-sm form-control" id="EndTime" name="EndTime" value="<?php echo date('m/d/Y'); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
